    ...
    return (
      <Card className="max-w-4xl mx-auto">
        <CardContent className="py-24 text-center">
          ...
          <h3 className="text-2xl font-bold mb-4">Тест Струпа</h3>
          <p className="text-gray-600 mb-8 max-w-md mx-auto">
            Выбирайте ЦВЕТ текста, а не значение слова. Это сложнее, чем кажется!
          </p>
          <Button onClick={startGame} className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white px-8 py-6 text-lg">
            Начать тест
          </Button>
        </CardContent>
      </Card>
      ...
      <Card className="max-w-4xl mx-auto">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-2xl mb-2">Цветная реакция</CardTitle>
              <Badge className="bg-pink-100 text-pink-700">{difficultyNames[difficulty]}</Badge>
            </div>
            <div className="flex items-center space-x-6">
              <div className="text-center">
                <div className="text-sm text-gray-600">Вопрос</div>
                <div className="text-2xl font-bold">{currentQuestion + 1}/{settings.questions}</div>
              </div>
              <div className="text-center">
        ...
        <CardContent>
          <div className="text-center py-12">
            <p className="text-sm text-gray-600 mb-8">Какого ЦВЕТА этот текст?</p>
            <div className="text-8xl font-bold mb-12" style={{ color: COLOR_MAP[question.color] }}>
        ...
        <div className="py-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center p-4 bg-red-50 rounded-lg">
              ...
              <div className="text-2xl font-bold text-red-600">{settings.questions - score}</div>
            </div>
          </div>

          <div className="flex space-x-3 pt-4">
            <Button onClick={handleRestart} className="flex-1 bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700">
